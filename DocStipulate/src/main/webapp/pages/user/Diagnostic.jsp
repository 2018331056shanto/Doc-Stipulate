...
<div class="form-container">
 <form:form class="form-container" action="/register/diagnostic" modelAttribute="registerDiagnostic" method="POST">
 <div class="input">
 <label class="label" for="name">Diagnostic Center Name</label>
 <div class="error">${Name}</div>
 <input name="name" type="text" class="input-box" id="name" placeholder="Diagnostic Center Name"  onfocus="true"/>
 </div>
 <div class="input">
 <label class="label" for="location">Diagnostic Center Location</label>
  <div class="error">${location}</div>
 	<input class="input-box" id="location" placeholder="Location ..." name="location" type="text"  onfocus="true"/>
